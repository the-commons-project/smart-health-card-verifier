...
const getPatientDataFromFhir = credential => {
  ...
  if (patientEntry) {
    ...
    dateOfBirth = (0, _utils.formatDateOfBirth)(birthDate);
  }
  return {
    names,
    dateOfBirth,
...
exports.getPatientDataFromFhir = getPatientDataFromFhir;
