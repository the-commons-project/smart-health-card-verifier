...
//     console.log('OpenSSL not available to validate the X.509 certificate chain skipping validation', ErrorCode.OPENSSL_NOT_AVAILABLE)
//     return
//   }
...
//     //
//     const logX5CError = (field:string) => console.log(`Can't parse ${field} in the issuer's cert (in x5c JWK value)`, ErrorCode.INVALID_KEY_X5C)
...
//             }
//           }
//           console.log(`Invalid subject alternative name prefix. Expected: 6 (URI). Actual: ${subjectAltNameExt['tag']} (${getTagName(subjectAltNameExt['tag'])})`, ErrorCode.INVALID_KEY_X5C)
//         }
...
//     }
//   } catch (err) {
//     console.log('Error validating x5c certificates: ' + (err as Error).toString(), ErrorCode.INVALID_KEY_X5C)
//   } finally {
//     certFiles.map((file) => {
//       // fs.unlinkSync(file)
//     })
